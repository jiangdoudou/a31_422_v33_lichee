...
#define REPORT_REPEAT_KEY_VALUE  // add by cjcheng support the mouse mode 2013-12-03

/* add by cjcheng start {----------------------------------- */
/* flicker led when receive ir signal 2013-12-03 */
#define CONFIG_IR_SUN7I_LED
